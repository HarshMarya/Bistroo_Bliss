  ...
  return (
    <>
      <section className="bg-[#f9f9f7]">
        <div className="flex justify-between p-4 md:p-10 lg:p-10 xl:p-10 mx-auto w-10/12 flex-wrap-reverse lg:flex-nowrap lg:gap-14  ">
          {/* Image container */}
          <div className="relative my-10">
            <img src={roll} className="w-fit md:w-full" />
            <div className="bg-[#474747] w-fit h-fit lg:w-[400px] my-2 rounded-lg md:absolute -right-10 -bottom-20 text-white p-4 md:p-6 flex flex-col gap-4">
